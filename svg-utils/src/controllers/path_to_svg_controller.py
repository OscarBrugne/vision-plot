...
path_to_svg_controller: Bottle = Bottle()

svg_service: PathToSVGService = PathToSVGService()


@path_to_svg_controller.post("/generate-single-path")
def generate_single_path() -> Dict[str, str]:
    """
    ...
    svg_string: str = svg_service.generate_line_path_svg(
...
@path_to_svg_controller.post("/generate-multiple-paths")
def generate_multiple_paths():
    ...
    svg_string: str = svg_service.generate_multiple_line_paths_svg(
